...
Write-Host "`n📋 Listing resources in resource group..." -ForegroundColor Cyan
try {
...
Write-Host "`n🔍 Testing resource existence checks..." -ForegroundColor Cyan
...
foreach ($resource in $resources) {
    ...
    try {
        ...
        if ($result) {
            Write-Host "  ✅ $($resource.Type) exists" -ForegroundColor Green
...
Write-Host "`n✅ Resource existence check completed!" -ForegroundColor Green
Write-Host "   Use this information to validate the import logic in the GitHub Actions workflow." -ForegroundColor Gray
