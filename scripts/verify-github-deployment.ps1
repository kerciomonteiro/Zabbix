...
Write-Host ""
Write-Host "🏗️ Infrastructure Files:" -ForegroundColor Yellow
Write-Host "------------------------" -ForegroundColor Yellow
...
Write-Host ""
Write-Host "☸️ Kubernetes Manifests:" -ForegroundColor Yellow
Write-Host "------------------------" -ForegroundColor Yellow
...
Write-Host "-------------------------" -ForegroundColor Yellow
Write-Host "⚠️ Please ensure you have configured the following secret in GitHub:" -ForegroundColor Yellow
